...
(function (global, factory) {
...
}(this, (function (exports, d3Dispatch, d3TimeFormat, d3Format, d3Selection, d3Collection, d3Array, d3Time, d3Scale, d3Timer, d3Interpolate, d3ScaleChromatic, d3Axis, d3Zoom, d3Brush, d3Shape, d3Geo, d3Ease, d3Hierarchy) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    const BaseMixin$1 = BaseMixinExt(BaseMixin);
    const baseMixin = (parent, chartGroup) => new BaseMixin$1(parent, chartGroup);
    ...
    function ColorMixin$1(Base) {
        return class extends ColorMixinExt(ColorMixin(BaseMixinExt(Base))) {
            constructor(...args) {
                super(...args);
            }
        };
    ...
    // @ts-ignore
    const CoordinateGridMixin$1 = CoordinateGridMixinExt(ColorMixinExt(MarginMixinExt(BaseMixinExt(CoordinateGridMixin))));
    ...
    const StackMixin$1 = StackMixinExt(CoordinateGridMixinExt(ColorMixinExt(MarginMixinExt(BaseMixinExt(StackMixin)))));
    ...
    class BarChart$1 extends StackMixinExt(CoordinateGridMixinExt(ColorMixinExt(MarginMixinExt(BaseMixinExt(BarChart))))) {
        constructor(parent, chartGroup) {
            super(parent, chartGroup);
        }
        centerBar(centerBar) {
    ...
    const barChart = (parent, chartGroup) => new BarChart$1(parent, chartGroup);
    ...
    class BoxPlot$1 extends CoordinateGridMixinExt(ColorMixinExt(MarginMixinExt(BaseMixinExt(BoxPlot)))) {
        constructor(parent, chartGroup) {
            super(parent, chartGroup);
        }
    ...
    const boxPlot = (parent, chartGroup) => new BoxPlot$1(parent, chartGroup);
    ...
    class BubbleChart$1 extends BubbleMixinExt(
    // @ts-ignore
    CoordinateGridMixinExt(ColorMixinExt(MarginMixinExt(BaseMixinExt(BubbleChart))))) {
        constructor(parent, chartGroup) {
            super(parent, chartGroup);
        }
    }
    const bubbleChart = (parent, chartGroup) => new BubbleChart$1(parent, chartGroup);
    ...
    class BubbleOverlay$1 extends BubbleMixinExt(ColorMixinExt(BaseMixinExt(BubbleOverlay))) {
        constructor(parent, chartGroup) {
            super(parent, chartGroup);
        }
        /**
    ...
    const bubbleOverlay = (parent, chartGroup) => new BubbleOverlay$1(parent, chartGroup);
    ...
    class CboxMenu$1 extends BaseMixinExt(CboxMenu) {
        constructor(parent, chartGroup) {
            super(parent, chartGroup);
        }
        order(order) {
    ...
    const cboxMenu = (parent, chartGroup) => new CboxMenu$1(parent, chartGroup);
    ...
    const CompositeChart$1 = CompositeChartExt(CoordinateGridMixinExt(ColorMixinExt(MarginMixinExt(BaseMixinExt(CompositeChart)))));
    const compositeChart = (parent, chartGroup) => new CompositeChart$1(parent, chartGroup);
    ...
    class DataCount$1 extends BaseMixinExt(DataCount) {
        dimension(cf) {
    ...
    const dataCount = (parent, chartGroup) => new DataCount$1(parent, chartGroup);
    ...
    class DataGrid$1 extends BaseMixinExt(DataGrid) {
        constructor(parent, chartGroup) {
            super(parent, chartGroup);
        }
        section(section) {
    ...
    const dataGrid = (parent, chartGroup) => new DataGrid$1(parent, chartGroup);
    ...
    // @ts-ignore, remove after group method is moved here
    class DataTable$1 extends BaseMixinExt(DataTable) {
        constructor(parent, chartGroup) {
            super(parent, chartGroup);
        }
        section(section) {
    ...
    const dataTable = (parent, chartGroup) => new DataTable$1(parent, chartGroup);
    ...
    class GeoChoroplethChart$1 extends ColorMixinExt(BaseMixinExt(GeoChoroplethChart)) {
        constructor(parent, chartGroup) {
            super(parent, chartGroup);
        }
        /**
    ...
    const geoChoroplethChart = (parent, chartGroup) => new GeoChoroplethChart$1(parent, chartGroup);
    ...
    class HeatMap$1 extends ColorMixinExt(MarginMixinExt(BaseMixinExt(HeatMap))) {
        constructor(parent, chartGroup) {
            super(parent, chartGroup);
        }
    ...
    const heatMap = (parent, chartGroup) => new HeatMap$1(parent, chartGroup);
    ...
    class LineChart$1 extends StackMixinExt(CoordinateGridMixinExt(ColorMixinExt(MarginMixinExt(BaseMixinExt(LineChart))))) {
        constructor(parent, chartGroup) {
            super(parent, chartGroup);
        }
    }
    const lineChart = (parent, chartGroup) => new LineChart$1(parent, chartGroup);
    ...
    class NumberDisplay$1 extends BaseMixinExt(NumberDisplay) {
        constructor(parent, chartGroup) {
            super(parent, chartGroup);
        }
        formatNumber(formatter) {
    ...
    const numberDisplay = (parent, chartGroup) => new NumberDisplay$1(parent, chartGroup);
    ...
    class PieChart$1 extends CapMixinExt(ColorMixinExt(BaseMixinExt(PieChart))) {
        constructor(parent, chartGroup) {
            super(parent, chartGroup);
        }
        emptyTitle(title) {
    ...
    const pieChart = (parent, chartGroup) => new PieChart$1(parent, chartGroup);
    ...
    class RowChart$1 extends CapMixinExt(ColorMixinExt(MarginMixinExt(BaseMixinExt(RowChart)))) {
        constructor(parent, chartGroup) {
            super(parent, chartGroup);
    ...
    const rowChart = (parent, chartGroup) => new RowChart$1(parent, chartGroup);
    ...
    class ScatterPlot$1 extends CoordinateGridMixinExt(ColorMixinExt(MarginMixinExt(BaseMixinExt(ScatterPlot)))) {
        constructor(parent, chartGroup) {
            super(parent, chartGroup);
        }
        useCanvas(useCanvas) {
    ...
    const scatterPlot = (parent, chartGroup) => new ScatterPlot$1(parent, chartGroup);
    ...
    class SelectMenu$1 extends BaseMixinExt(SelectMenu) {
        constructor(parent, chartGroup) {
            super(parent, chartGroup);
        }
        order(order) {
    ...
    const selectMenu = (parent, chartGroup) => new SelectMenu$1(parent, chartGroup);
    ...
    class SeriesChart$1 extends CompositeChartExt(CoordinateGridMixinExt(ColorMixinExt(MarginMixinExt(BaseMixinExt(SeriesChart))))) {
        constructor(parent, chartGroup) {
            super(parent, chartGroup);
        }
        chart(chartFunction) {
    ...
    const seriesChart = (parent, chartGroup) => new SeriesChart$1(parent, chartGroup);
    ...
    class SunburstChart$1 extends ColorMixinExt(BaseMixinExt(SunburstChart)) {
        constructor(parent, chartGroup) {
            super(parent, chartGroup);
        }
        innerRadius(innerRadius) {
    ...
    const sunburstChart = (parent, chartGroup) => new SunburstChart$1(parent, chartGroup);
    ...
    class TextFilterWidget$1 extends BaseMixinExt(TextFilterWidget) {
        constructor(parent, chartGroup) {
            super(parent, chartGroup);
        }
        normalize(normalize) {
    ...
    const textFilterWidget = (parent, chartGroup) => new TextFilterWidget$1(parent, chartGroup);
    ...
    class HtmlLegend$1 extends HtmlLegend {
        constructor() {
            super();
        }
    }
    const htmlLegend = () => new HtmlLegend$1();
    ...
    class Legend$1 extends Legend {
        constructor() {
            super();
        }
    }
    const legend = () => new Legend$1();

    const version = "5.0.0-alpha0";

    exports.BadArgumentException = BadArgumentException;
    exports.BarChart = BarChart$1;
    exports.BaseMixin = BaseMixin$1;
    exports.BaseMixinExt = BaseMixinExt;
    exports.BoxPlot = BoxPlot$1;
    exports.BubbleChart = BubbleChart$1;
    exports.BubbleMixinExt = BubbleMixinExt;
    exports.BubbleOverlay = BubbleOverlay$1;
